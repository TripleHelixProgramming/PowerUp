 ...
 *
 */
public class AutoGroupNoDeliver extends CommandGroup {
	
  	 public AutoGroupNoDeliver(SrxTrajectory path, Height elevatorHeight, double elevatorDelay) {
    	this(path, elevatorHeight, elevatorDelay, null);
     }

     public AutoGroupNoDeliver(SrxTrajectory path, Height elevatorHeight, double elevatorDelay, Command phase2) {
