...
public class SlowJoystickDrive extends Command {
    ...
    protected void execute() {
    	...
    	throttle = oi.getThrottle() * ((0.7 * (1 - Robot.elevator.getHeightPercentage(true))) + 0.3);
    	turn = oi.getTurn() * ((0.4 * (1 - Robot.elevator.getHeightPercentage(true))) + 0.6);
    	
    	drivetrain.arcadeDrive(throttle, turn, false);
    	
    	drivetrain.adjustForHeight(elevator.getHeightPercentage(true));
    }
